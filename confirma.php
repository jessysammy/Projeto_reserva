  ...
  <body>
    ...
    <div class="page">
              ...
              <div class="rd-navbar-main">
                ...
                <div class="rd-navbar-main-element">
                  <div class="rd-navbar-nav-wrap">
                    ...
                    </ul><a class="button button-white button-sm" href="#"></a>
                  </div>
                </div><a class="button button-white button-sm" href="#"></a>
              </div>
            </div>
          </nav>
        </div>
      ...
      <div class="bg-gray-1">
        ...
        <p>Obrigado, <span class="info">[Nome do Cliente]</span>! Sua reserva foi confirmada para o dia <span class="info">[Data da Reserva]</span> às <span class="info">[Hora]</span>.</p>
        <p>Um SMS será enviado para o número <span class="info">[Número de Telefone do Cliente]</span> com mais detalhes.</p>
