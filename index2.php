          ...
          <div class="container">
              ...
              <div class="container">
                ...
                <form action="/submit" method="post">
                    ...
                    <input type="tel" id="telefone" name="telefone" placeholder="(00) XXXXX-01010 " pattern="[0-9]{2} [0-9]{5}-[0-9]{4}" required>
        
                    <label for="data">Data:</label>
                    <input type="text" id="nome" name="nome" placeholder="10/10/2024" required>
        
                    <label for="nome">Numero de Pessoas:</label>
                    <input type="text" id="nome" name="nome" placeholder="5" required>
